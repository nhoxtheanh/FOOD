// Messages
    ...
    const priceErrMsg = "Giá tiền phải lớn hơn 0";
    ...
    const recipeImgErrMsg = "Chọn ảnh minh họa món ăn";
    ...
    const duplicateIngreErrMsg = "Món ăn có nguyên liệu bị trùng";
    const noDishSelectedErrMsg = "Chưa có bài đăng nào được chọn";
    const wantToAccepRecipeMsg = "Bạn có chắc muốn chấp nhận món ăn này ?";
